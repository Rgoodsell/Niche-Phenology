...
```{r, fig.cap="Figure 4. Changes in phenological reaction norms with temperature"}
...
Figure 4 illustrates how phenological reaction norms vary with environmental space (in this case temperature gradients). 
